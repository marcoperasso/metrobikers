...
<div class="row">
    <div class="col-md-1"></div>
    <div class="col-md-5">
        <p>Amica, amico, questo è un prodotto per gente giovane! Attenzione però... non intendiamo in senso anagrafico, ma <b>giovane di spirito</b>! Prima di spiegarti di che si tratta, lascia che descriviamo il profilo dell'ECOmmuter...</p>
        ...
        <p>L'ECOmmuter ama avvalersi di strumenti moderni, non si lascia vincolare da inerzie e abitudini; sa che l'automobile è ormai un mezzo obsoleto per spostarsi in ambito urbano: 
            la sua velocità media è inferiore a quella del cavallo, principale mezzo di trasporto nelle città del 1700, ma soprattutto è causa di smog, rumore, congestione, incidenti.</p>
        ...
        <p><b>Con ECOmmuters possiamo cambiare rotta</b>: registriamo i nostri ciclo-itinerari urbani utilizzando l'applicazione per smartphone, troviamo persone che abitualmente
            percorrono in bicicletta i nostri stessi tragitti e facciamo gruppo. Condividiamo con loro i problemi incontrati e le soluzioni adottate.
